...
router.post('/:uid/documents', passportCall('jwt'), authorization(['admin', 'user', 'premium']), passport.authenticate('jwt', { session: false }), uploader.fields([{ name: 'profilePic', maxCount: 1 }, { name: 'productImage', maxCount: 5 }, { name: 'identification', maxCount: 1 }, { name: 'location', maxCount: 1 }, { name: 'accountStatus', maxCount: 1 }]), usersController.uploadDocs)
